...
import Client.Models.Coordinates;
import Client.Models.Vehicle;
import Client.Models.VehicleType;
import Common.Utilites.Console;
import Client.Exception.NumberValueException;
...
public class Ask implements Serializable {
    ...
    public static Vehicle askVehicle(Console console, Long id) throws AskBreak, NumberValueException {
        String name;
        while (true){
